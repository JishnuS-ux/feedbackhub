  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-1">Data insights across all feedback</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
            ...
            <div className="h-72">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={ratingData}>
                  ...
                  <XAxis dataKey="rating" axisLine={false} tickLine={false} tick={{ fill: isDarkMode ? '#9ca3af' : '#6b7280' }} dy={10} />
                  <YAxis allowDecimals={false} axisLine={false} tickLine={false} tick={{ fill: isDarkMode ? '#9ca3af' : '#6b7280' }} dx={-10} />
                  <RechartsTooltip 
                    cursor={{ fill: isDarkMode ? '#374151' : '#f3f4f6' }}
                    contentStyle={{ backgroundColor: isDarkMode ? '#1f2937' : '#ffffff', borderColor: isDarkMode ? '#374151' : '#e5e7eb', borderRadius: '8px', color: isDarkMode ? '#ffffff' : '#000000' }}
                  />
        ...
        <div className="card p-6">
          <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-6">Feedback by Product</h3>
          {loading ? (
             <div className="h-72 flex items-center justify-center text-gray-400">Loading chart...</div>
